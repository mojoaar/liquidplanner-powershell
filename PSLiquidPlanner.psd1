#
# Module manifest for module 'PSLiquidPlanner'
#
# Generated by: Morten G. Johansen
#
# Generated on: 21-06-2017
#

@{

# Script module or binary module file associated with this manifest.
RootModule = 'PSLiquidPlanner.psm1'
...
NestedModules = @(
    ...
    'PSLiquidPlanner-Activity.psm1',
    'PSLiquidPlanner-Project.psm1'
)
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('Azure','Automation','Liquid Planner', 'API')

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/mgjohansen/liquidplanner-powershell/blob/master/LICENSE'
